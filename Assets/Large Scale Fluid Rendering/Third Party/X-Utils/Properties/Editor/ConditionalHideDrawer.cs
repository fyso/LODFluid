...
class ConditionalHideDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            if(conditionalHideAttribute.MinValue < conditionalHideAttribute.MaxValue)
            {
                property.floatValue = EditorGUI.Slider(position, property.displayName, property.floatValue, conditionalHideAttribute.MinValue, conditionalHideAttribute.MaxValue);
            }
            else
            {
